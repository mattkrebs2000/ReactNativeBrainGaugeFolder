...
const Exercisemanage = ({ navigation }) => {
    ...
    return firebase
      ...
      .then(function (querySnapshot) {
        querySnapshot.forEach(function (doc) {
          ...
          if (newData.text4 > 0 && yourData.indexOf(newData.id) == -1) {
    ...
    <SafeAreaView style={styles.container2}>
      <View>
        <TouchableOpacity style={styles.middle}>
          <Text style={styles.text2}>Exercise Data</Text>
              ...
              <ListItem key={i} style={styles.text6}>
                ...
                >
                  <Text style={{ fontSize: scale(17) }}>
                    {i + 1}. Rating: {info.text4} Speed: {info.speed}
                  </Text>
                </TouchableOpacity>
