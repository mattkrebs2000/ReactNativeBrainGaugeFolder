              ...
              <ListItem key={i} style={styles.text6}>
                <TouchableOpacity style={styles.divide}>
                  <Text style={{ fontSize: 17 }}>
                    {i + 1}. {info.currentDate} at {info.currentTime}. Speed:{" "}
                    {info.speed}
                  </Text>
                </TouchableOpacity>
